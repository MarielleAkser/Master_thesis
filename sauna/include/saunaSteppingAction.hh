...
//
//
/// \file saunaSteppingAction.hh
/// \brief Definition of the saunaSteppingAction class
...
{
  public:
    saunaSteppingAction(saunaEventAction* eventAction);
    virtual ~saunaSteppingAction();
