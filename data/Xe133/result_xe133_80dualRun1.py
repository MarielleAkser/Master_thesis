...
eDep_file_t0 = np.genfromtxt('xe133_80dualRun1_t0.csv', delimiter=',')
eDep_file_t1 = np.genfromtxt('xe133_80dualRun1_t1.csv', delimiter=',')
...
for rad in eDep:
        nr_events += 1
        """gamma:[1] = 80.997 +- 5 keV --> 0.0266 & 0.0366 MeV,
        beta:[11] > 0"""
        a_row = []
        t = []
        if ( (0.075997 <= rad[1] <= 0.085997) and rad[7] > 0):
                a_row.append(rad[1])
                a_row.append(rad[7])
...
print("% of coincidence for 80dualRun1 xe133:", coin_procent )
