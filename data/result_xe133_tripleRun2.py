...
eDep_file_t0 = np.genfromtxt('xe133_tripleRun2_t0.csv', delimiter=',')
eDep_file_t1 = np.genfromtxt('xe133_tripleRun2_t1.csv', delimiter=',')
...
print("% for Run2:", (len(c) / len(eDep)) * 100 )
