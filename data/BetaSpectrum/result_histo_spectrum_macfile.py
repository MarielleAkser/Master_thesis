...
# GEANT4-files:
eDep_file_t0 = np.genfromtxt('histo_spectrum_macfile_t0.csv', delimiter=',')
eDep_file_t1 = np.genfromtxt('histo_spectrum_macfile_t1.csv', delimiter=',')
...
print("len: ", len(Xe133_beta) )
print("tot len: ", len(eDep))
print("%: ",len(Xe133_beta) / len(eDep) )
...
plt.xlim(0, 0.4)
plt.title("Xe133 beta decay, from /histo/")
plt.legend()
plt.savefig("Plot_Xe133_beta_spectrum_from_histo.png")
plt.show()